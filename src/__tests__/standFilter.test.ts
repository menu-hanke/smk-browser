...
const data1Geometry = wkt.parse(
  'POLYGON((393960.156 6801453.126, 394798.608 6801657.878, 394930.512 6801670.111, 395028.723 6802116.858, 394258.945 6801929.148, 394261.711 6801810.541, 394091.166 6801665.961, 393960.156 6801453.126))'
)

const bboxToPolygon = ([x1, y1, x2, y2]: number[]) => wkt.parse(`POLYGON((${x1} ${y1}, ${x2} ${y1}, ${x2} ${y2}, ${x1} ${y2}, ${x1} ${y1}))`)
const finlandGeometry = bboxToPolygon([-3669433.9, 4601644.86, 648181.26, 9364104.12])

const southernFinlandGeometry = bboxToPolygon([-3669433.9, 4601644.86, 648181.26, 6982874.49])
const northernFinlandGeometry = bboxToPolygon([-3669433.9, 6982874.49, 648181.26, 9364104.12])

...
export const createPolygonsFromXml = (xml: any) => {
  ...
  function extractPolygon(stand: any) {
    ...
    const standNumber = Number(stand[`${xmlNsStand}:StandBasicData`][0][`${xmlNsStand}:StandNumber`][0])
    ...
    return turf.polygon(polygonArray, { name: 'polygon', standNumber: standNumber })
  }

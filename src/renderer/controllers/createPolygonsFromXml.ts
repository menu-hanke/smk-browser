...
export const createPolygonsFromXml = (xml: any) => {
 ...
 function extractPolygon(stand : any) {
    ...
    const exterior =
      stand[`${xmlNsStand}:StandBasicData`][0][`${xmlNsGeometricDataTypes}:PolygonGeometry`][0][`${xmlNsGml}:polygonProperty`][0][
      `${xmlNsGml}:Polygon`][0][`${xmlNsGml}:exterior`][0][`${xmlNsGml}:LinearRing`][0][`${xmlNsGml}:coordinates`][0]
    ...
    const interiors =
      stand[`${xmlNsStand}:StandBasicData`][0][`${xmlNsGeometricDataTypes}:PolygonGeometry`][0][`${xmlNsGml}:polygonProperty`][0][
      `${xmlNsGml}:Polygon`][0][`${xmlNsGml}:interior`]
